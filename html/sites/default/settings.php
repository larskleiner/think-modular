 ...
 * @endcode
 */
$settings['hash_salt'] = '1b2-WkwEl9rVC1kaPKCyBoHGXWIZR5XlrURBhyidsKQbGTri6UVmVLQcZcuh1X-ccBn61ULFlg';
...
$settings['env'] = \getenv('ENVIRONMENT');

# Load Redis services even if Redis module is not (yet) enabled.
...
if (empty($trusted_host_patterns)) {
  ...
  foreach ($trusted_host_patterns as $trusted_host_pattern) {
